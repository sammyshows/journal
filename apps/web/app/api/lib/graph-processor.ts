import { Pool } from 'pg';
import { GraphNode, GraphEdge, GraphExtractionResult } from './entity-extraction';
...
let graphProcessor: GraphProcessor | null = null;

export function getGraphProcessor(): GraphProcessor {
  if (!graphProcessor) {
